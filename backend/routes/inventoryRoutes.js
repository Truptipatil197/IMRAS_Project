...
// ITEM ROUTES
router.post('/items', isManager, itemCreateValidators, validate, createItem);
router.get('/items', getAllItems);
router.get('/items/:id', param('id').isInt(), validate, getItemById);
router.put('/items/:id', isManager, param('id').isInt(), itemUpdateValidators, validate, updateItem);
...
router.get('/items/:id/suppliers', param('id').isInt(), validate, getItemSuppliers);
